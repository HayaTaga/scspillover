# scspill Replication Package (ECTJ)

This repository is organized for The Econometrics Journal reproducibility checks.

Primary entry point for the Data Editor:
- `README_submit.md`
